            ...
            >
              <PopoverTrigger asChild>
                <Button 
                  ...
                  onClick={() => console.log("[DebugTrace] Calendar Trigger Clicked")}
                >
              ...
              <PopoverContent 
                ...
                onPointerDownOutside={(e) => {
                  console.log("[DebugTrace] Popover PointerDownOutside! Target:", e.target);
                }}
                onInteractOutside={(e) => {
                  console.log("[DebugTrace] Popover InteractOutside! Target:", e.target);
                }}
              >
                <Calendar
                  mode="single"
